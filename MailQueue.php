...
use annkirilenko\mailqueue\Message;
use annkirilenko\mailqueue\models\Queue;
 ...
 *
 * This extension replaces `yii\switmailer\Message` with `annkirilenko\mailqueue\Message'
...
class MailQueue extends Mailer
{
	 ...
	 */
	public $messageClass = 'annkirilenko\mailqueue\Message';
